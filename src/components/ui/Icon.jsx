export default function Icon({ name, size = 18 }) {
  const paths = {
    ...
    mountain: <path d="M22 20L13.5 7l-4 6-3-3L2 20h20z"/>,
    ...
    accessibility: <><circle cx="12" cy="4" r="2"/><path d="M19 13v-2a7 7 0 0 0-14 0v2"/><path d="M9 22V11"/><path d="M15 22V11"/></>,
    pin: <><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></>,
    clock: <><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></>,
    leaf: <><path d="M21 3v8a8 8 0 0 1-8 8H5a2 2 0 0 1-2-2v-1c0-7 6-13 13-13h5z"/><path d="M3 21c0-6 4-10 10-10"/></>,
